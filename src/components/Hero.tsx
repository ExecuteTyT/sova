                ...
                {sent ? (
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="shrink-0 flex items-center justify-center w-12 h-12 bg-accent text-white rounded-sm hover:bg-accent-hover hover:shadow-[0_8px_24px_rgba(163,106,59,0.5)] hover:scale-105 transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
